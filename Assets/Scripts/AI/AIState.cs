...
public abstract class AIState : MonoBehaviour
{
    ...
    // Desc :   Called by the parent state mchine to allow root motion
    //          processing
    // -----------------------------------------------------------------
    ...
    // Desc :   Convers the passed sphere collider's position and radius into
    ...
    public static void ConvertSphereColliderToWorldSpace(SphereCollider col, out Vector3 pos, out float radius)
    {
        ...
        // If no valid speher collider return
        if (col == null)
            return;
